            ...
            <div className="max-w-7xl mx-auto px-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <motion.div
                        ...
                        className="bg-blue-50 p-8 rounded-3xl shadow-sm border-l-4 border-[#1E90FF]"
                    >
                        <h3 className="text-2xl font-bold text-[#0A3D62] mb-3">Our Mission</h3>
                    ...
                    <motion.div
                        ...
                        className="bg-blue-50 p-8 rounded-3xl shadow-sm border-l-4 border-[#1E90FF]"
                    >
                        <h3 className="text-2xl font-bold text-[#0A3D62] mb-3">Our Vision</h3>
                        <p className="text-gray-600 leading-relaxed">
