                ...
                <div className="grid grid-cols-1 pb-16 pt-20 lg:grid-cols-12 gap-12 md:pt-0">
                    ...
                    <div className="lg:col-span-5">
                        ...
                        <div className="lg:col-span-7 flex flex-col gap-4">
                            ...
                            <div className="flex flex-wrap items-start gap-2">
                                <a href="https://www.instagram.com/the.auto_mate" target="_blank" rel="noopener noreferrer" className="p-2.5 rounded-xl border border-white/10 hover:bg-white/5 cursor-pointer"><Instagram size={20} /></a>
                                <a href="https://www.linkedin.com/in/theauto-mate" target="_blank" rel="noopener noreferrer" className="p-2.5 rounded-xl border border-white/10 hover:bg-white/5 cursor-pointer"><Linkedin size={20} /></a>
                                <a href="https://www.youtube.com/@the.auto-mate" target="_blank" rel="noopener noreferrer" className="p-2.5 rounded-xl border border-white/10 hover:bg-white/5 cursor-pointer">
                                    <Image src="/icons/youtube.png" alt="YouTube" width={20} height={20} className="invert brightness-0" />
                                </a>
                                <a href="https://t.me/theautomate" target="_blank" rel="noopener noreferrer" className="p-2.5 rounded-xl border border-white/10 hover:bg-white/5 cursor-pointer"><Send size={20} /></a>
                                <a href="https://wa.me/919361142819" target="_blank" rel="noopener noreferrer" className="p-2.5 rounded-xl border border-white/10 hover:bg-white/5 cursor-pointer"> <Image src="/icons/whatsapp.png" alt="WhatsApp" width={20} height={20} className="" /></a>
                            </div>
                    ...
                    <div className="lg:col-span-7 grid grid-cols-2 sm:grid-cols-7 gap-12">
                        <div className="lg:col-span-3">
                            <h4 className="font-bold mb-6 text-white uppercase text-lg tracking-widest whitespace-nowrap">Company</h4>
                        ...
                        <div className="sm:col-span-4">
                            <h4 className="font-bold mb-6 text-white uppercase text-lg tracking-widest whitespace-nowrap">Legal Information</h4>
                            <ul className="space-y-4 text-gray-400 text-sm">
